...
/**
 * Backend registry — kept for future extensibility.
 * Currently only Kiro (ACP) is supported.
 */
export const BACKENDS = [
  {
    ...
    label: 'Kiro',
    fields: [
      { key: 'ai_kiro_command', label: 'CLI Command', placeholder: 'kiro-cli', type: 'text' },
    ],
  },
];
